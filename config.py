...
LINE_ACCESS_TOKEN = os.getenv('LINE_ACCESS_TOKEN', '6rJb6v5xfB+GByowhbjpXbRIz7iNwb/MU0rJQbUjVcKVM5l5PN901F7EfJnS0fd6ZCSiBc7DEaHc/5DC4t4/pl6RuB9zQXxdW38lcdiuHToGb+nwJqHSPcVudAl3/F+x/k9blGyakcHr0+MXBVocYwdB04t89/1O/w1cDnyilFU=')
...
ESP32_API_PORT = int(os.getenv("ESP32_API_PORT", 5010))
...
# Microservices URLs
IOT_BROKER_PORT = int(os.getenv('IOT_BROKER_PORT', 5002))
IOT_BROKER_URL = f"http://{os.getenv('IOT_BROKER_HOST', 'localhost')}:{IOT_BROKER_PORT}"
TELEGRAM_IM_URL = f"http://{TELEGRAM_API_HOST}:{TELEGRAM_API_PORT}"
LINE_IM_URL = f"http://{LINE_API_HOST}:{LINE_API_PORT}"
IOT_DEVICE_PORT = int(os.getenv('IOT_DEVICE_PORT', 5003))
IOT_DEVICE_URL = f"http://{os.getenv('IOT_DEVICE_HOST', 'localhost')}:{IOT_DEVICE_PORT}"
